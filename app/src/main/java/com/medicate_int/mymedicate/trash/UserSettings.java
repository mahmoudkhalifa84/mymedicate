    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.ll_set_lang).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                statics.setMY_PLACE("تغيير اللغة2");
        ...
        view.findViewById(R.id.ll_set_country).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                statics.setMY_PLACE("تغيير البلد2");
                startActivity(new Intent(getActivity(), HomeActivity.class));
            }
        });
        view.findViewById(R.id.adv_s_edit_info).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                statics.setMY_PLACE("تعديل البيانات الشخصية");
                startActivity(new Intent(getActivity(), HomeActivity.class));
            }
        });
        ...
        view.findViewById(R.id.settings_tech_supprot).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                statics.setMY_PLACE("المحادثة الفورية2");
                startActivity(new Intent(getActivity(), HomeActivity.class));
            }
        });
        return view;
    ...
    private void sendPrp(String trim, String phone, Object selectedItem) {
        try {
            ...
            DatabaseReference myRef =
                    database.getReference("FeedBack_PROBLEM").child(Calendar.getInstance().getTime().toString());
