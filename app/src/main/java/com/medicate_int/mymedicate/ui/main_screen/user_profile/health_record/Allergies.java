...
public class Allergies extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_alhassiat, container, false);
        view.findViewById(R.id.ha_but_add).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                go();
            }
        });
        view.findViewById(R.id.ha_img_add).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                go();
            }
    ...
    private void go() {
        ...
        dialog.setContentView(R.layout.add_hasasia_dailog); //todo
