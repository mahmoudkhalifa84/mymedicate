...
public cityCustomAdapter(Context context, ArrayList<CitiesModel> cityList)
        {
...
private View initView(int position, View convertView, ViewGroup parent )
        ...
        if(convertView == null)
        {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.city_row_spinner, parent, false);
        }
